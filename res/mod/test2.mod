...
N1B1(Gamestop.jpg, {null,pc,null}, center, null, surprise.wav, null, "Also you chose [C:green][F:3:ham,turkey] on [C:blue][F:1:white,wheat] in [C:red]Test [C:red]1.", null, null, null, null)
