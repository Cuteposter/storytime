...
#VALUES
#scene and sound can be found in the res directory
...
start(Gamestop.jpg, {null,gen,null}, center, null, null, "I'm pretty [C:blue]hungry today. Let's make a [C:green]sandwich! \nDo you want to help me make a [C:green]sandwich?", {"Yes","No","MOOOOOOOODS"}, {0,-1,-1}, null, {N1B1,N1B2,N1B3})
N1B1(Gamestop.jpg, {gen,null,vita}, right, question, wonder.wav, "What should the [C:green]bread be?", {"White","Wheat"}, {1,2}, null, {N2BA})
